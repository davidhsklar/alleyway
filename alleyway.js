...
Alleyway.Boot = function(game) {
    this.game = game;
};

Alleyway.Boot.prototype = {
...
Alleyway.Menu = function(game) {
    this.game = game;
};

Alleyway.Menu.prototype = {
...
Alleyway.Game = function(game) {
    this.game = game;
};

Alleyway.Game.prototype = {
...
Alleyway.GameOver = function(game) {
    this.game = game;
};

Alleyway.GameOver.prototype = {
...
game.state.add('Boot', Alleyway.Boot);
game.state.add('Menu', Alleyway.Menu);
game.state.add('Game', Alleyway.Game);
game.state.add('GameOver', Alleyway.GameOver);
